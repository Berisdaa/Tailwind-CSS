  ...
  <div class="w-full min-h-screen font-sans text-gray-900">
    ...
    <div class="px-6 mx-auto max-w-6xl">
      <div class="flex flex-col-reverse items-center md:flex-row lg:items-end">
        <div class="md:w-1/2 pt-24 pb-24 text-center md:pb-12 md:text-left pr-8">
            <h1 class="relative z-10 text-5xl md:text-6xl font-bold font-display">
              Learn the 
          <span 
        class="relative after:content-[url(/img/scratch.svg)] after:absolute after:-top-2 after:-right-3 after:-z-1"
        >best
        </span> 
        ways for staying 
        <span class="relative after:content-[url(/img/decoration.svg)] after:absolute after:-bottom-2 after:-right-3 after:-z-1">productive</span> 
            </h1>
            <p class="pt-8 text-lg leading-relaxed text-gray-500 max-w-md md:justify-start">
              Working at home is definitely a convient option and makes sense in
    ...
    <div class="bg-gray-50">
      <div class="py-12 px-6 mx-auto max-w-6xl">
        <div class="flex flex-col gap-5 md:flex-row">
          ...
          class="flex flex-col p-8 space-y-4 bg-white rounded-lg border border-gray-200 transition-shadow duration-500 ease-out hover:shadow-xl cursor-pointer">
